...
func (db *Database) SaveCode(code types.Code) error {
	stmt := `
...
func (db *Database) GetCodeData(codeID uint64) (*types.CodeData, error) {
...
func (db *Database) SetCodeData(data types.CodeData) error {
